...
CytronMD motor_right(PWM_PWM, 6, 7);   // PWM 2A = Pin 8, PWM 2B = Pin 9.

//****** Left Motor Encoder Pins **********
#define ENCLA 2 // BLACK
#define ENCLB 3 // WHITE


//****** Right Motor Encoder Pins **********
#define ENCRA 13 // BLACK
#define ENCRB 12 // WHITE
...
float count_per_rev_lm = 224.0;// <======== set this number according to your motor (count per rev) for left motor
...
double LM_kp = 1.2, LM_ki = 0.000 , LM_kd = 0.0000;          // modify for optimal performance
...
double RM_kp = 1.2, RM_ki = 0.000 , RM_kd = 0.0000;          // modify for optimal performance
